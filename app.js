...
//  DATA
// ═══════════════════════════════════
var CU=null, CUSTS=[], PRODS=[], ADMINS=[], ORDERS=[], CONNECTIONS=[], NID=10;
...
var DP=[
  // ── 50 FRUITS ──
  {id:1,name:'Ripe Red Papaya',cat:'fruit',price:32000,unit:'per 100kg',desc:'Vibrant sun-ripened Sri Lankan papaya with velvety red flesh. Rich in Vitamin C and antioxidants. Harvested daily from Kurunegala farms.',emoji:'🍈',avail:true,img:'https://images.unsplash.com/photo-1526318472351-c75fcf070305?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:2,name:'Sweet Mango (Willard)',cat:'fruit',price:48000,unit:'per 100kg',desc:'Juicy Willard mangoes at peak ripeness. Naturally sweet golden-orange flesh with tropical aroma. Colombo market favourite.',emoji:'🥭',avail:true,img:'https://images.unsplash.com/photo-1601493700631-2b16ec4b4716?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:3,name:'Banana (Ambul)',cat:'fruit',price:22000,unit:'per 100kg',desc:'Classic Sri Lankan Ambul banana. Sweet, slightly tangy flavour. Perfect for eating fresh or cooking. Grown in Kandy and Matale regions.',emoji:'🍌',avail:true,img:'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:4,name:'Fresh Pineapple (Kew)',cat:'fruit',price:26000,unit:'per 100kg',desc:'Golden Kew pineapples at peak season from Kurunegala valley. Intensely aromatic with perfect sweet-acid balance.',emoji:'🍍',avail:true,img:'https://images.unsplash.com/photo-1550258987-190a2d41a8ba?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:5,name:'Watermelon',cat:'fruit',price:15000,unit:'per 100kg',desc:'Heavy sweet watermelons from the dry zone. Deep red flesh with extremely high water content. Perfect for hot days.',emoji:'🍉',avail:true,img:'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:6,name:'Passion Fruit',cat:'fruit',price:85000,unit:'per 100kg',desc:'Aromatic passion fruit from Nuwara Eliya highlands. Intense tropical flavour, perfect for juices and desserts.',emoji:'🟣',avail:true,img:'https://images.unsplash.com/photo-1604495772376-9657f0035a7b?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:7,name:'Avocado',cat:'fruit',price:95000,unit:'per 100kg',desc:'Creamy Sri Lankan avocados from Kandy and Badulla districts. Rich in healthy fats and nutrients. Perfect for smoothies.',emoji:'🥑',avail:true,img:'https://images.unsplash.com/photo-1519162808019-7de1683fa2ad?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:8,name:'Guava (Pink)',cat:'fruit',price:28000,unit:'per 100kg',desc:'Sweet pink-fleshed guava from the North Western Province. Rich in Vitamin C and dietary fibre. Great eaten fresh.',emoji:'🍐',avail:true,img:'https://images.unsplash.com/photo-1536511132770-e5058c7e8c46?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:9,name:'Wood Apple (Divul)',cat:'fruit',price:35000,unit:'per 100kg',desc:'Traditional Sri Lankan wood apple with unique tangy-sweet flavour. Used for juices, chutneys and Ayurvedic medicine.',emoji:'🟤',avail:true,img:'https://images.unsplash.com/photo-1597362925123-77861d3fbac7?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:10,name:'Rambutan',cat:'fruit',price:45000,unit:'per 100kg',desc:'Exotic hairy tropical fruit from the South of Sri Lanka. Juicy white flesh with a sweet refreshing taste. Seasonal favourite.',emoji:'🔴',avail:true,img:'https://images.unsplash.com/photo-1623227536986-1f72aeecaba7?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:11,name:'Mangosteen',cat:'fruit',price:120000,unit:'per 100kg',desc:'The Queen of Fruits from Sri Lankan rainforests. Delicate white segments with an exquisite sweet-tangy flavour.',emoji:'🟣',avail:true,img:'https://images.unsplash.com/photo-1474885600849-7a22e26a4ee0?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:12,name:'Durian',cat:'fruit',price:180000,unit:'per 100kg',desc:'The King of Fruits. Rich custard-like flesh with complex flavour. Grown in the wet zone of Sri Lanka.',emoji:'🟡',avail:false,img:'https://images.unsplash.com/photo-1554112092-64994fecb8b8?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:13,name:'Banana (Kolikuttu)',cat:'fruit',price:30000,unit:'per 100kg',desc:'Premium Kolikuttu banana — the most flavourful Sri Lankan variety. Smaller, sweeter and more aromatic than regular bananas.',emoji:'🍌',avail:true,img:'https://images.unsplash.com/photo-1528825871115-3581a5387919?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:14,name:'Jackfruit (Kos)',cat:'fruit',price:25000,unit:'per 100kg',desc:'Giant tropical jackfruit from Sri Lankan villages. Eaten ripe as sweet fruit or unripe as a meat substitute in curries.',emoji:'🟡',avail:true,img:'https://images.unsplash.com/photo-1596057625209-c9a1e8b01bd6?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:15,name:'Lime (Dehi)',cat:'fruit',price:38000,unit:'per 100kg',desc:'Tangy Sri Lankan lime essential for cooking. Adds bright citrus flavour to curries, sambols and fresh juices.',emoji:'🍋',avail:true,img:'https://images.unsplash.com/photo-1592940354710-6b332e3a1651?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:16,name:'Orange (Navel)',cat:'fruit',price:55000,unit:'per 100kg',desc:'Juicy navel oranges imported and grown in cooler highlands. Rich in Vitamin C. Perfect for fresh juice.',emoji:'🍊',avail:true,img:'https://images.unsplash.com/photo-1611080626919-7cf5a9dbab12?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:17,name:'Grape (Red Seedless)',cat:'fruit',price:145000,unit:'per 100kg',desc:'Sweet red seedless grapes. Premium quality fruit popular for gifting and desserts.',emoji:'🍇',avail:true,img:'https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:18,name:'Apple (Fuji)',cat:'fruit',price:135000,unit:'per 100kg',desc:'Crisp Fuji apples with perfect sweet-tart balance. Imported and highly popular in Sri Lankan markets.',emoji:'🍎',avail:true,img:'https://images.unsplash.com/photo-1576179635662-9d1983e97e1e?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:19,name:'Strawberry',cat:'fruit',price:320000,unit:'per 100kg',desc:'Fresh strawberries from Nuwara Eliya cool climate farms. Bright red, sweet and aromatic. Perfect for desserts.',emoji:'🍓',avail:true,img:'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:20,name:'Mango (Karuthakolomban)',cat:'fruit',price:52000,unit:'per 100kg',desc:'Traditional Sri Lankan Karuthakolomban mango. Fibreless, sweet and aromatic. Considered the best local variety.',emoji:'🥭',avail:true,img:'https://images.unsplash.com/photo-1546349851-64285be8e9fa?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:21,name:'Soursop (Katu Anoda)',cat:'fruit',price:65000,unit:'per 100kg',desc:'Spiky tropical soursop with creamy white flesh. Sweet-sour flavour used for juices and ice cream.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1601493700518-43b6d81a9d90?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:22,name:'Pomelo (Jambola)',cat:'fruit',price:40000,unit:'per 100kg',desc:'Large fragrant pomelo from the dry zone. Sweet-bitter citrus taste. Rich in antioxidants and Vitamin C.',emoji:'🟡',avail:true,img:'https://images.unsplash.com/photo-1546548970-71785318a17b?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:23,name:'Lemon',cat:'fruit',price:42000,unit:'per 100kg',desc:'Fresh yellow lemons for cooking and drinks. Essential kitchen ingredient used in Sri Lankan cuisine daily.',emoji:'🍋',avail:true,img:'https://images.unsplash.com/photo-1587486913049-53fc88980cfc?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:24,name:'Coconut (Pol)',cat:'fruit',price:18000,unit:'per 100kg',desc:'Mature brown coconuts. Essential ingredient in Sri Lankan cooking. Used for milk, sambol, curries and oil.',emoji:'🥥',avail:true,img:'https://images.unsplash.com/photo-1548266652-99cf27701ced?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:25,name:'King Coconut (Thambili)',cat:'fruit',price:24000,unit:'per 100kg',desc:'Fresh orange king coconuts. Natural electrolytes and hydration. Harvested daily from Kelaniya farms.',emoji:'🥥',avail:true,img:'https://images.unsplash.com/photo-1560637902-e019f5a8c5e7?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:26,name:'Sapodilla (Sapotu)',cat:'fruit',price:55000,unit:'per 100kg',desc:'Brown caramel-sweet sapodilla fruit. Grainy soft texture with a uniquely sweet flavour beloved in Sri Lanka.',emoji:'🟤',avail:true,img:'https://images.unsplash.com/photo-1599087572745-f9f0b6a5e8a4?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:27,name:'Star Fruit (Carambola)',cat:'fruit',price:48000,unit:'per 100kg',desc:'Exotic star-shaped fruit with waxy yellow skin. Crisp juicy flesh with sweet-sour flavour. Eaten fresh or juiced.',emoji:'⭐',avail:true,img:'https://images.unsplash.com/photo-1526318472351-c75fcf070305?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:28,name:'Banana (Seeni Kesel)',cat:'fruit',price:35000,unit:'per 100kg',desc:'Sweet finger bananas — the honey banana variety. Extremely sweet and fragrant. Popular as a dessert fruit.',emoji:'🍌',avail:true,img:'https://images.unsplash.com/photo-1481349518771-20055b2a7b24?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:29,name:'Breadfruit (Del)',cat:'fruit',price:20000,unit:'per 100kg',desc:'Starchy breadfruit from village gardens. Versatile cooking ingredient used in curries, chips and boiled dishes.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1596046741898-e2d3a3c00524?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:30,name:'Tamarind (Siyambala)',cat:'fruit',price:75000,unit:'per 100kg',desc:'Sour tamarind pods used in curries, chutneys and drinks. Essential flavour in Sri Lankan and South Asian cooking.',emoji:'🟤',avail:true,img:'https://images.unsplash.com/photo-1605522469906-3fe226b356bc?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:31,name:'Pomegranate',cat:'fruit',price:95000,unit:'per 100kg',desc:'Ruby-red pomegranate packed with antioxidants. Juicy seeds with sweet-tart flavour. Grown in dry zone Sri Lanka.',emoji:'🔴',avail:true,img:'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:32,name:'Fig (Attikka)',cat:'fruit',price:110000,unit:'per 100kg',desc:'Fresh and dried figs from local gardens. Sweet honey-like flavour. Rich in fibre and minerals.',emoji:'🟣',avail:false,img:'https://images.unsplash.com/photo-1601379760449-79e32eeae78d?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:33,name:'Longan',cat:'fruit',price:85000,unit:'per 100kg',desc:'Small juicy longans with translucent white flesh. Sweet grape-like flavour. Seasonal tropical delicacy.',emoji:'⚪',avail:true,img:'https://images.unsplash.com/photo-1622597467836-f3e3d6e63d2a?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:34,name:'Melon (Honeydew)',cat:'fruit',price:45000,unit:'per 100kg',desc:'Sweet pale green honeydew melon. Juicy refreshing flesh great for fruit salads and chilled desserts.',emoji:'🍈',avail:true,img:'https://images.unsplash.com/photo-1571575173700-afb9492e6a50?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:35,name:'Dragon Fruit (Red)',cat:'fruit',price:145000,unit:'per 100kg',desc:'Vibrant pink dragon fruit with sweet red flesh. Rich in antioxidants. Grown in North Western Province.',emoji:'🔴',avail:true,img:'https://images.unsplash.com/photo-1527325678964-54921661f888?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:36,name:'Dragon Fruit (White)',cat:'fruit',price:125000,unit:'per 100kg',desc:'White-fleshed dragon fruit with mild sweet flavour. Beautiful presentation for fruit platters and juices.',emoji:'⚪',avail:true,img:'https://images.unsplash.com/photo-1555949760-2d1e3d524d9b?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:37,name:'Mango (Totapuri)',cat:'fruit',price:38000,unit:'per 100kg',desc:'Large Totapuri mangoes with firm yellow flesh. Less sweet but perfect for pickles, chutneys and raw salads.',emoji:'🥭',avail:true,img:'https://images.unsplash.com/photo-1601493700631-2b16ec4b4716?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:38,name:'Custard Apple (Seetha)',cat:'fruit',price:72000,unit:'per 100kg',desc:'Creamy white custard apple with sweet fragrant flesh. Seeds are black and inedible. Beloved Sri Lankan fruit.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1601493700518-43b6d81a9d90?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:39,name:'Papaya (Green, Raw)',cat:'fruit',price:18000,unit:'per 100kg',desc:'Raw green papaya for cooking. Essential ingredient for papaya curry, salads and pickles in Sri Lankan cuisine.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:40,name:'Banana (Anamalu)',cat:'fruit',price:25000,unit:'per 100kg',desc:'Large cooking banana variety. Used for banana chips, curries and boiled dishes. Staple Sri Lankan ingredient.',emoji:'🍌',avail:true,img:'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:41,name:'Pear (Korean)',cat:'fruit',price:165000,unit:'per 100kg',desc:'Crisp juicy Korean pears. Very sweet and refreshing. Premium imported fruit popular in Sri Lankan markets.',emoji:'🍐',avail:true,img:'https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:42,name:'Kiwi Fruit',cat:'fruit',price:285000,unit:'per 100kg',desc:'Tangy green kiwi fruit packed with Vitamin C. Imported premium fruit. Popular for desserts and fruit salads.',emoji:'🥝',avail:true,img:'https://images.unsplash.com/photo-1585059895524-72359e06133a?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:43,name:'Pineapple (Queen)',cat:'fruit',price:30000,unit:'per 100kg',desc:'Smaller sweeter Queen variety pineapple. More intense flavour than Kew. Perfect for desserts and fresh eating.',emoji:'🍍',avail:true,img:'https://images.unsplash.com/photo-1550258987-190a2d41a8ba?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:44,name:'Lychee (Lichi)',cat:'fruit',price:135000,unit:'per 100kg',desc:'Fragrant lychees with juicy translucent white flesh. Sweet floral flavour. Highly seasonal and sought-after.',emoji:'🔴',avail:false,img:'https://images.unsplash.com/photo-1566842600175-97dca03f6da0?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:45,name:'Coconut (Young King)',cat:'fruit',price:28000,unit:'per 100kg',desc:'Young tender king coconut with soft jelly flesh. Both the water and flesh are consumed. Highly nutritious.',emoji:'🥥',avail:true,img:'https://images.unsplash.com/photo-1560637902-e019f5a8c5e7?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:46,name:'Melon (Cantaloupe)',cat:'fruit',price:55000,unit:'per 100kg',desc:'Orange-fleshed cantaloupe melon with sweet musky aroma. Grown in dry zone. Rich in beta-carotene.',emoji:'🍊',avail:true,img:'https://images.unsplash.com/photo-1571575173700-afb9492e6a50?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:47,name:'Banana (Puwalu)',cat:'fruit',price:28000,unit:'per 100kg',desc:'Medicinal Puwalu banana variety. Used for digestive health. Smaller than regular bananas with unique earthy flavour.',emoji:'🍌',avail:true,img:'https://images.unsplash.com/photo-1528825871115-3581a5387919?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:48,name:'Mango (Gira Amba)',cat:'fruit',price:42000,unit:'per 100kg',desc:'Traditional village Gira Amba mango. Fibreless sweet flesh. Grows wild in Sri Lankan home gardens.',emoji:'🥭',avail:true,img:'https://images.unsplash.com/photo-1546349851-64285be8e9fa?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:49,name:'Jackfruit (Waraka)',cat:'fruit',price:32000,unit:'per 100kg',desc:'Soft Waraka variety jackfruit with intense sweetness. Best eaten fully ripe. Loved by Sri Lankans as a seasonal treat.',emoji:'🟡',avail:false,img:'https://images.unsplash.com/photo-1596057625209-c9a1e8b01bd6?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:50,name:'Beli Fruit (Bael)',cat:'fruit',price:58000,unit:'per 100kg',desc:'Sacred beli fruit used in Ayurvedic medicine. Sweet-sour sherbet drink from this fruit is famous across Sri Lanka.',emoji:'🟡',avail:true,img:'https://images.unsplash.com/photo-1597362925123-77861d3fbac7?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},

  // ── 50 VEGETABLES ──
  {id:51,name:'Red Tomato',cat:'vegetable',price:14000,unit:'per 100kg',desc:'Plump vine-ripened tomatoes from Jaffna fertile red soil. Perfect acidity for curries, salads and sauces.',emoji:'🍅',avail:true,img:'https://images.unsplash.com/photo-1546094096-0df4bcaaa337?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:52,name:'Garden Carrot',cat:'vegetable',price:18000,unit:'per 100kg',desc:'Crisp organic carrots from Nuwara Eliya cool highlands. Deep orange colour and naturally sweet flavour.',emoji:'🥕',avail:true,img:'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:53,name:'Green Cabbage',cat:'vegetable',price:12000,unit:'per 100kg',desc:'Fresh green cabbage from up-country farms. Crunchy leaves perfect for mallum, stir-fries and salads.',emoji:'🥬',avail:true,img:'https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:54,name:'Leek',cat:'vegetable',price:22000,unit:'per 100kg',desc:'Fresh Nuwara Eliya leeks. Mild onion flavour. Essential ingredient in Sri Lankan egg hoppers and stir-fries.',emoji:'🌿',avail:true,img:'https://images.unsplash.com/photo-1497534446932-c925b458314e?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:55,name:'Brinjal (Purple)',cat:'vegetable',price:16000,unit:'per 100kg',desc:'Glossy purple brinjal (eggplant) — one of Sri Lanka\'s most beloved vegetables. Used in curries, moju and tempura.',emoji:'🍆',avail:true,img:'https://images.unsplash.com/photo-1604495772376-9657f0035a7b?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:56,name:'Bitter Gourd (Karawila)',cat:'vegetable',price:20000,unit:'per 100kg',desc:'Bitter gourd famous in Sri Lankan medicine. Controls blood sugar. Used in stir-fries and Ayurvedic preparations.',emoji:'🥒',avail:true,img:'https://images.unsplash.com/photo-1601493700920-26d34d8b5d38?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:57,name:'Snake Gourd (Pathola)',cat:'vegetable',price:15000,unit:'per 100kg',desc:'Long snake gourd used in traditional Sri Lankan curries. Light flavour, absorbs spices beautifully.',emoji:'🥒',avail:true,img:'https://images.unsplash.com/photo-1601493700920-26d34d8b5d38?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:58,name:'Ladies Fingers (Okra)',cat:'vegetable',price:18000,unit:'per 100kg',desc:'Tender okra pods with mild flavour. Used in curries and stir-fries. Rich in fibre and Vitamin K.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1601493700518-43b6d81a9d90?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:59,name:'Green Capsicum',cat:'vegetable',price:22000,unit:'per 100kg',desc:'Crisp green capsicum with mild slightly bitter flavour. Used in stir-fries, rice dishes and salads.',emoji:'🫑',avail:true,img:'https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:60,name:'Red Capsicum',cat:'vegetable',price:28000,unit:'per 100kg',desc:'Sweet red capsicum with vibrant colour. Richer in Vitamin C than green varieties. Excellent for salads.',emoji:'🫑',avail:true,img:'https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:61,name:'Green Beans',cat:'vegetable',price:20000,unit:'per 100kg',desc:'Tender green beans from Nuwara Eliya. Crisp texture with fresh flavour. Excellent stir-fried with coconut.',emoji:'🫘',avail:true,img:'https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:62,name:'Pumpkin (Wattakka)',cat:'vegetable',price:10000,unit:'per 100kg',desc:'Sri Lankan pumpkin with sweet orange flesh. Used in creamy curries and soups. Very nutritious and filling.',emoji:'🎃',avail:true,img:'https://images.unsplash.com/photo-1570586437263-ab629fccc818?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:63,name:'Sweet Potato',cat:'vegetable',price:14000,unit:'per 100kg',desc:'Orange-fleshed sweet potato from the dry zone. Naturally sweet. Boiled, curried or made into chips.',emoji:'🟠',avail:true,img:'https://images.unsplash.com/photo-1596097556575-0f2e6d0d6fce?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:64,name:'Potato (Up-Country)',cat:'vegetable',price:28000,unit:'per 100kg',desc:'Fresh up-country potatoes from Nuwara Eliya. Firm texture with earthy flavour. Essential for Sri Lankan cooking.',emoji:'🥔',avail:true,img:'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:65,name:'Red Onion (Lunu)',cat:'vegetable',price:35000,unit:'per 100kg',desc:'Small red shallots essential in Sri Lankan cuisine. Pungent flavour base for all curries and sambols.',emoji:'🧅',avail:true,img:'https://images.unsplash.com/photo-1518977822534-7049a61ee0c2?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:66,name:'White Onion (Big)',cat:'vegetable',price:28000,unit:'per 100kg',desc:'Large white onions from Matale and Dambulla regions. Milder than red onions. Used in various dishes.',emoji:'🧅',avail:true,img:'https://images.unsplash.com/photo-1508747703725-719777637510?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:67,name:'Garlic',cat:'vegetable',price:65000,unit:'per 100kg',desc:'Pungent garlic from Sri Lankan farms and imports. Essential flavour base in all Sri Lankan cooking.',emoji:'🧄',avail:true,img:'https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:68,name:'Ginger (Inguru)',cat:'vegetable',price:55000,unit:'per 100kg',desc:'Fresh ginger root with strong warm flavour. Used extensively in Sri Lankan cooking, medicine and tea.',emoji:'🟡',avail:true,img:'https://images.unsplash.com/photo-1568584711271-6c929fb49b60?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:69,name:'Drumstick (Murunga)',cat:'vegetable',price:24000,unit:'per 100kg',desc:'Moringa drumstick — a superfood vegetable. Used in curries and sambols. Extremely nutritious leaves and pods.',emoji:'🌿',avail:true,img:'https://images.unsplash.com/photo-1601493700920-26d34d8b5d38?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:70,name:'Gotukola (Pennywort)',cat:'vegetable',price:30000,unit:'per 100kg',desc:'Traditional Sri Lankan herb with medicinal properties. Used fresh in sambol with coconut. Brain health superfood.',emoji:'🌿',avail:true,img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:71,name:'Spinach (Nivithi)',cat:'vegetable',price:25000,unit:'per 100kg',desc:'Tender Ceylon spinach with mild flavour. Cooked as a stir-fry with garlic. Rich in iron and vitamins.',emoji:'🥬',avail:true,img:'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:72,name:'Kangkung (Water Spinach)',cat:'vegetable',price:18000,unit:'per 100kg',desc:'Aquatic kangkung greens grown in Sri Lankan waterways. Used in stir-fries with coconut and spices.',emoji:'🥬',avail:true,img:'https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:73,name:'Cauliflower',cat:'vegetable',price:32000,unit:'per 100kg',desc:'White cauliflower from Nuwara Eliya cool climate. Used in curries, fried snacks and salads.',emoji:'🥦',avail:true,img:'https://images.unsplash.com/photo-1568584711271-6c929fb49b60?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:74,name:'Broccoli',cat:'vegetable',price:48000,unit:'per 100kg',desc:'Fresh dark green broccoli from hill country farms. Nutritional powerhouse. Popular in health-conscious households.',emoji:'🥦',avail:true,img:'https://images.unsplash.com/photo-1459411621453-7b03977f4bfc?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:75,name:'Cucumber (Thiyambara)',cat:'vegetable',price:12000,unit:'per 100kg',desc:'Crisp fresh cucumbers. Eaten raw in salads, raita and as a cooling snack. Grown in the dry zone.',emoji:'🥒',avail:true,img:'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:76,name:'Radish (Raabu)',cat:'vegetable',price:15000,unit:'per 100kg',desc:'White radish with peppery fresh flavour. Used in salads, pickles and as a garnish. Common in Sri Lankan meals.',emoji:'⚪',avail:true,img:'https://images.unsplash.com/photo-1518977822534-7049a61ee0c2?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:77,name:'Beet Root',cat:'vegetable',price:22000,unit:'per 100kg',desc:'Deep purple beetroot with sweet earthy flavour. Used in salads, curries and fresh juice. Rich in iron.',emoji:'🔴',avail:true,img:'https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:78,name:'Ash Plantain (Alu Kesel)',cat:'vegetable',price:16000,unit:'per 100kg',desc:'Raw ash plantain cooked as a vegetable in Sri Lankan curries. Starchy with mild flavour. Very filling.',emoji:'🍌',avail:true,img:'https://images.unsplash.com/photo-1481349518771-20055b2a7b24?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:79,name:'Long Beans (Mae Kari)',cat:'vegetable',price:18000,unit:'per 100kg',desc:'Long yard-long beans from Sri Lankan gardens. Used in stir-fries and curries. Crunchy fresh taste.',emoji:'🫘',avail:true,img:'https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:80,name:'Winged Bean (Dambala)',cat:'vegetable',price:25000,unit:'per 100kg',desc:'Unique winged bean with frilly edges. Entire plant is edible. Mild flavour used in Sri Lankan salads.',emoji:'🫘',avail:true,img:'https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:81,name:'Cluster Beans (Kassoali)',cat:'vegetable',price:22000,unit:'per 100kg',desc:'Bitter cluster beans used in traditional Sri Lankan side dishes. Nutritious and high in fibre.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1601493700920-26d34d8b5d38?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:82,name:'Corn (Maize)',cat:'vegetable',price:20000,unit:'per 100kg',desc:'Fresh sweet corn on the cob. Grilled, boiled or made into corn curry. Popular street food in Sri Lanka.',emoji:'🌽',avail:true,img:'https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:83,name:'Spring Onion',cat:'vegetable',price:30000,unit:'per 100kg',desc:'Fresh spring onions with mild flavour. Used as garnish and in fried rice, noodles and sambols.',emoji:'🌿',avail:true,img:'https://images.unsplash.com/photo-1597362925123-77861d3fbac7?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:84,name:'Celery',cat:'vegetable',price:45000,unit:'per 100kg',desc:'Crisp celery stalks from highland farms. Used in soups, stir-fries and as a healthy snack.',emoji:'🌿',avail:true,img:'https://images.unsplash.com/photo-1528750717929-32abb73d3bd9?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:85,name:'Lettuce (Iceberg)',cat:'vegetable',price:35000,unit:'per 100kg',desc:'Crisp iceberg lettuce from Nuwara Eliya. Perfect for salads, burgers and wraps. Very popular in Colombo.',emoji:'🥬',avail:true,img:'https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:86,name:'Green Chilli (Miris)',cat:'vegetable',price:28000,unit:'per 100kg',desc:'Fresh hot green chillies. Essential spice in Sri Lankan cooking. Adds heat to curries, sambols and sauces.',emoji:'🌶️',avail:true,img:'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:87,name:'Red Chilli (Rathu Miris)',cat:'vegetable',price:35000,unit:'per 100kg',desc:'Fiery red chillies used fresh and dried. The colour and heat of Sri Lankan curries depends on these.',emoji:'🌶️',avail:true,img:'https://images.unsplash.com/photo-1583119022894-919a68a3d0e3?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:88,name:'Knol Khol (Kohlrabi)',cat:'vegetable',price:18000,unit:'per 100kg',desc:'Mild sweet kohlrabi from up-country farms. Used in salads and stir-fries. Crisp water chestnut-like texture.',emoji:'🟣',avail:true,img:'https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:89,name:'Ash Gourd (Ash Puhul)',cat:'vegetable',price:10000,unit:'per 100kg',desc:'Large waxy ash gourd used in curries and as a cooling Ayurvedic drink. Very popular in Sri Lankan cooking.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1571575173700-afb9492e6a50?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:90,name:'Ridge Gourd (Watakolu)',cat:'vegetable',price:14000,unit:'per 100kg',desc:'Ridged gourd with spongy texture. Used in curries with coconut milk. Popular in coastal Sri Lanka.',emoji:'🥒',avail:true,img:'https://images.unsplash.com/photo-1601493700920-26d34d8b5d38?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:91,name:'Yam (Kesavelu)',cat:'vegetable',price:28000,unit:'per 100kg',desc:'Sri Lankan yam with starchy firm flesh. Boiled, curried or made into chips. Nutritious root vegetable.',emoji:'🟤',avail:true,img:'https://images.unsplash.com/photo-1596097556575-0f2e6d0d6fce?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:92,name:'Cassava (Manioc)',cat:'vegetable',price:12000,unit:'per 100kg',desc:'Starchy cassava root. Boiled with sambol, fried as chips or made into flour. Sri Lankan staple food.',emoji:'🟤',avail:true,img:'https://images.unsplash.com/photo-1596097556575-0f2e6d0d6fce?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:93,name:'Breadfruit (Flower)',cat:'vegetable',price:15000,unit:'per 100kg',desc:'Young unripe breadfruit used as a vegetable. Starchy texture similar to potato. Made into delicious curries.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1596046741898-e2d3a3c00524?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:94,name:'Banana Flower (Kesel Muwa)',cat:'vegetable',price:20000,unit:'per 100kg',desc:'Fresh banana flower used as a vegetable. Made into curries and stir-fries. Traditional Sri Lankan ingredient.',emoji:'🌸',avail:true,img:'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:95,name:'Jackfruit (Young, Polos)',cat:'vegetable',price:18000,unit:'per 100kg',desc:'Young unripe jackfruit (Polos) — a famous Sri Lankan curry ingredient. Tastes like pulled meat when cooked.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1596057625209-c9a1e8b01bd6?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:96,name:'Curry Leaves (Karapincha)',cat:'vegetable',price:45000,unit:'per 100kg',desc:'Fresh aromatic curry leaves. Essential flavour in Sri Lankan tempering. Used in virtually every curry dish.',emoji:'🌿',avail:true,img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:97,name:'Lemongrass (Sera)',cat:'vegetable',price:35000,unit:'per 100kg',desc:'Fresh lemongrass with citrus fragrance. Used in curries, teas and herbal remedies. Grown in home gardens.',emoji:'🌿',avail:true,img:'https://images.unsplash.com/photo-1528750717929-32abb73d3bd9?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:98,name:'Aubergine (White Brinjal)',cat:'vegetable',price:20000,unit:'per 100kg',desc:'White variety brinjal with milder flavour than purple. Used in curries and pickled moju. Village favourite.',emoji:'⚪',avail:true,img:'https://images.unsplash.com/photo-1604495772376-9657f0035a7b?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:99,name:'Chayote (Seeni Maththa)',cat:'vegetable',price:16000,unit:'per 100kg',desc:'Light green chayote squash from highland farms. Mild flavour used in curries, stir-fries and salads.',emoji:'🟢',avail:true,img:'https://images.unsplash.com/photo-1601493700920-26d34d8b5d38?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
  {id:100,name:'Mukunuwenna',cat:'vegetable',price:28000,unit:'per 100kg',desc:'Traditional Sri Lankan green herb. Used in sambol and stir-fries. Rich in nutrients and medicinal properties.',emoji:'🌿',avail:true,img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80',by:'oshan',byn:'P.A.O. Angel'},
];
...
function load(){
  try{
    var a=localStorage.getItem('pp_a'),
        o=localStorage.getItem('pp_o'),c=localStorage.getItem('pp_c'),
        cn=localStorage.getItem('pp_cn'),n=localStorage.getItem('pp_n');
    if(a)ADMINS=JSON.parse(a);
    if(o)ORDERS=JSON.parse(o); if(c)CUSTS=JSON.parse(c);
    if(cn)CONNECTIONS=JSON.parse(cn); if(n)NID=parseInt(n);
    // Always reload products fresh from DP (100 products)
    // Only keep admin-added products on top
    var adminProds=[];
    var stored=localStorage.getItem('pp_p');
    if(stored){
      var old=JSON.parse(stored);
      // Keep only products NOT added by oshan (i.e. seller admin products)
      adminProds=old.filter(function(p){return p.by!=='oshan';});
    }
    PRODS=JSON.parse(JSON.stringify(DP)).concat(adminProds);
    if(NID<101) NID=101;
    save();
  }catch(e){
